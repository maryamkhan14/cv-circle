  ...
  return (
    <div className="flex items-stretch md:items-center justify-center w-full h-full">
      <div className=" bg-green-300 rounded flex items-stretch md:flex-row shadow-md border m-3 w-11/12 md:w-auto md:h-auto max-w-5/6 max-h-5/6">
        <img
          src="src/assets/Oreti.png"
          className="hidden md:block w-3/5 max-h-screen"
        />
        <div className="bg-green-50 w-full flex flex-col justify-center px-3 py-5 font-[700] text-center">
          ...
          <span className="flex flex-col items-center justify-center mt-12">
            ...
            <button
              type="button"
              class="w-4/5 text-slate-50 bg-blue-700 hover:bg-blue-700/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
